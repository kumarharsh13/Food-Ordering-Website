...
!(function (e, t) {
  ...
  function T(e, t) {
    ...
    return (r = "scroll" + n) && (o = O(e, r))
      ...
      : N(e)
      ? (Fe[r] || Ie[r]) -
        (Ne["inner" + n] || Ie["client" + n] || Fe["client" + n])
      : e[r] - e["offset" + n];
  }
  ...
  function Wa(e) {
    var t,
      ...
      i = 0;
    if (g !== r || Ye) {
      for (F(); i < A.length; i += 4)
        (t = Ne.matchMedia(A[i]).matches) !== A[i + 3] &&
          ((A[i + 3] = t)
            ? n.push(i)
            : F(1, A[i]) || (W(A[i + 2]) && A[i + 2]()));
      for (I(), i = 0; i < n.length; i++)
        (t = n[i]), (He = A[t]), (A[t + 2] = A[t + 1](e));
  ...
  function pb(e, t, r, n, i, o, a, s, l, c, u, f, p) {
    W(e) && (e = e(s)),
      V(e) &&
        "max" === e.substr(0, 3) &&
        (e = f + ("=" === e.charAt(4) ? Ja("0" + e.substr(3), r) : 0));
    var d,
      g,
      h,
      v = p ? p.time() : 0;
    if ((p && p.seek(0), X(e))) a && E(a, r, n, !0);
      ...
      (h = Be(t)[0] || Fe),
        ...
        a && E(a, x, n, r - x < 20 || (a._isStart && 20 < x)),
        (r -= r - x);
    }
    if (o) {
      var S = e + r,
      ...
      (d = "scroll" + n.d2),
        E(
          ...
          n,
          (T && 20 < S) ||
            (!T && (u ? Math.max(Fe[d], Ie[d]) : o.parentNode[d]) <= S + 1)
        ),
        u &&
          ((l = dt(a)),
  ...
  function rb(e, t, r, n) {
    if (e.parentNode !== t) {
      var i,
        ...
        a = e.style;
      if (t === Fe) {
        for (i in ((e._stOrig = a.cssText), (o = va(e))))
          +i ||
            ee.test(i) ||
            !o[i] ||
            "string" != typeof a[i] ||
  ...
  var Le,
    ...
    ft = {
      ...
      sc: function sc(e) {
        return arguments.length
          ? Ne.scrollTo(e, pt.sc())
          : Ne.pageXOffset || Re[t] || Ie[t] || Fe[t] || 0;
      },
    },
    pt = {
      s: n,
      ...
      sc: function sc(e) {
        return arguments.length
          ? Ne.scrollTo(ft.sc(), e)
          : Ne.pageYOffset || Re[n] || Ie[n] || Fe[n] || 0;
      },
    },
    dt = function _getBounds(e, t) {
      var r =
          t &&
          "matrix(1, 0, 0, 1, 0, 0)" !== va(e)[u] &&
          Le.to(e, {
            x: 0,
            y: 0,
            xPercent: 0,
    ...
    I = function _revertRecorded(e) {
      for (var t = 0; t < R.length; t += 5)
        (e && R[t + 4] !== e) ||
          ((R[t].style.cssText = R[t + 1]),
          R[t].getBBox && R[t].setAttribute("transform", R[t + 2] || ""),
          (R[t + 3].uncache = 1));
    },
    F = function _revertAll(e, t) {
      var r;
      for (Je = 0; Je < vt.length; Je++)
        (r = vt[Je]), (t && r.media !== t) || (e ? r.kill(1) : r.revert());
      t && I(t), t || z("revert");
    },
    ...
    j = function _updateAll() {
      if (!h) {
        ...
        if (
          ...
          bt = 1;
        } else for (Je = 0; Je < e; Je++) vt[Je] && vt[Je].update(0, r);
        l = 0;
      }
    },
    H = [
      ...
      if (e) {
        ...
        for ((e.t._gsap || Le.core.getCache(e.t)).uncache = 1; o < i; o += 2)
          (r = e[o + 1]),
            ...
            r
              ? (n[t] = r)
              : n[t] && n.removeProperty(t.replace(G, "-$1").toLowerCase());
      }
    },
    yt = {
      left: 0,
  ...
  var te =
    ((ScrollTrigger.prototype.init = function init(E, k) {
      if (((this.progress = this.start = 0), this.vars && this.kill(1), Ge)) {
        var m,
          ...
          _e =
            "fixed" ===
            ("pinType" in E ? E.pinType : O(Oe, "pinType") || (Ee && "fixed")),
        ...
        if (
          ...
          (he *= 45),
          (Me.scroller = Oe),
          (Me.scroll = xe ? xe.time.bind(xe) : ze),
          (C = ze()),
          (Me.vars = E),
          (k = k || E.animation),
          ...
          (Me.tweenTo = m = l.tweenScroll[Se.p]),
          k &&
            ((k.vars.lazy = !1),
            k._initted ||
          ...
          me &&
            ...
            (f = W(me.snapTo)
              ...
              : Le.utils.snap(me.snapTo)),
            (p = me.duration || {
              min: 0.1,
              max: 2,
            }),
            (p = Y(p) ? Ve(p.min, p.max) : Ve(p, p)),
            (te = Le.delayedCall(me.delay || i / 2 || 0.1, function () {
                    ...
                    m(
                      a,
                      {
                        ...
                        onComplete: function onComplete() {
                          (g = ze()),
                            (S = G =
                              k && !Te ? k.totalProgress() : Me.progress),
                            d && d(Me),
                            c && c(Me);
                        },
                      },
          ...
          pe &&
            (!1 === de ||
              de === lt ||
              (de = !(!de && "flex" === va(pe.parentNode).display) && st),
            (Me.pin = pe),
            !1 !== E.force3D &&
              Le.set(pe, {
                force3D: !0,
              }),
            (n = Le.core.getCache(pe)).spacer
              ? (D = n.pinState)
              : (s &&
                  ((s = Be(s)[0]) &&
                    !s.nodeType &&
                ...
                (n.spacer = U = s || Re.createElement("div")),
                U.classList.add("pin-spacer"),
                o && U.classList.add("pin-spacer-" + o),
                (n.pinState = D = mb(pe))),
            (Me.spacer = U = n.spacer),
            (r = va(pe)),
            (x = r[de + Se.os2]),
            (H = Le.getProperty(pe)),
            (b = Le.quickSetter(pe, Se.a, ut)),
            jb(pe, U, r),
            (K = mb(pe))),
          c &&
            ((e = Y(c) ? xa(c, gt) : gt),
            (I = Ka("scroller-start", o, Oe, Se, e, 0)),
            (F = Ka("scroller-end", o, Oe, Se, e, 0, I)),
            (t = I["offset" + Se.op.d2]),
            (L = Ka("start", o, Oe, Se, e, t, 0, xe)),
            (R = Ka("end", o, Oe, Se, e, t, 0, xe)),
            xe && (oe = Le.quickSetter([L, R], Se.a, ut)),
            _e ||
              (Ze.length && !0 === O(Oe, "fixedMarkers")) ||
              ...
              (y = Le.quickSetter(I, Se.a, ut)),
              (w = Le.quickSetter(F, Se.a, ut)))),
          xe)
        ) {
        ...
        (Me.previous = function () {
          ...
          (Me.revert = function (e) {
            ...
            t !== Me.isReverted &&
              (t &&
                (Me.scroll.rec || (Me.scroll.rec = ze()),
                (ne = Math.max(ze(), Me.scroll.rec || 0)),
                (re = Me.progress),
                (ie = k && k.progress())),
              L &&
                [L, R, I, F].forEach(function (e) {
              ...
              if (pe && e && $e) Ea(ScrollTrigger, "scrollEnd", Xa);
                ...
                for (
                  var r,
                    ...
                    x =
                      E.start ||
                      (0 !== E.start && fe ? (pe ? "0 0" : "0 100%") : 0),
                    y = E.pinnedContainer && Be(E.pinnedContainer)[0],
                    w = (fe && Math.max(0, vt.indexOf(Me))) || 0,
                    S = w;
                  S--;
                ...
                for (
                  W(x) && (x = x(Me)),
                    A =
                      pb(x, fe, p, Se, ze(), L, I, Me, d, Pe, _e, g, xe) ||
                      (pe ? -0.001 : 0),
                    W(m) && (m = m(Me)),
                    V(m) &&
                      !m.indexOf("+=") &&
                ...
                if (
                  ...
                  (r = va(pe)),
                    (o = Se === pt),
                    (i = ze()),
                    (Z = parseFloat(H(Se.a)) + v),
                    !g &&
                      1 < z &&
                      ((Ee ? Fe : Oe).style["overflow-" + Se.a] = "scroll"),
                    jb(pe, U, r),
                    (K = mb(pe)),
                    (n = dt(pe, !0)),
                    (c = _e && P(Oe, o ? ft : pt)()),
                    de &&
                      ((($ = [de + Se.os2, B + v + ut]).t = U),
                      (S = de === st ? za(pe, Se) + B + v : 0) &&
                        $.push(Se.d, S + ut),
                      xt($),
                      _e && ze(ne)),
                    _e &&
                    ...
                    k
                      ? ((u = k._initted),
                        ...
                        (q = H(Se.a) - Z + B + v),
                        B !== q && j.splice(j.length - 2, 2),
                        k.render(0, !0, !0),
                        u || k.invalidate(),
                        Ke(0))
                      : (q = B);
                else if (fe && ze() && !xe)
                  for (n = fe.parentNode; n && n !== Fe; )
                    n._pinOffset && ((A -= n._pinOffset), (z -= n._pinOffset)),
                      (n = n.parentNode);
                f &&
                  ...
                  k &&
                    ...
                    k._initted &&
                    k.progress() !== ie &&
                    k.progress(ie, !0).render(k.time(), !0, !0),
                  re !== Me.progress &&
                    (ee && k.totalProgress(re, !0),
                    (Me.progress = re),
                    Me.update(0, 0, 1)),
                  pe && de && (U._pinOffset = Math.round(Me.progress * q)),
                  ce && ce(Me);
              }
          }),
          ...
          (Me.endAnimation = function () {
            _(Me.callbackAnimation),
              k &&
                (ee
                  ? ee.progress(1)
                  : k.paused()
                  ? Te || _(k, Me.direction < 0, 1)
                  : _(k, k.reversed()));
          }),
          (Me.getTrailing = function () {
            var e = vt.indexOf(Me);
            return 0 < Me.direction
              ? vt.slice(0, e).reverse()
              : vt.slice(e + 1);
          }),
            ...
            if (!xe || r || e) {
              ...
              if (
                (t &&
                  ((M = C),
                  (C = xe ? ze() : u),
                  me && ((G = S), (S = k && !Te ? k.totalProgress() : p))),
                he &&
                  !p &&
                  pe &&
                  !Xe &&
                ...
                if (
                  ((a =
                    (s = (n = Me.isActive = !!p && p < 1) != (!!d && d < 1)) ||
                    !!p != !!d),
                  (Me.direction = d < p ? 1 : -1),
                  (Me.progress = p),
                  a &&
                    !Xe &&
                  ...
                  we &&
                    ...
                    (W(we)
                      ? we(Me)
                      : Me.getTrailing().forEach(function (e) {
                ...
                !me || m.tween || Xe || Ye || te.restart(!0),
                  se &&
                    (s || (ve && p && (p < 1 || !Ue))) &&
                    Be(se.targets).forEach(function (e) {
                      return e.classList[n || ve ? "add" : "remove"](
                        se.className
                      );
                    }),
                  !ae || Te || e || ae(Me),
                  a && !Xe
                    ? (Te &&
                      ...
                      (!s && Ue) ||
                        (le && s && aa(Me, le),
                        ke[i] && aa(Me, ke[i]),
                        ve && (1 === p ? Me.kill(!1, 1) : (ke[i] = 0)),
                        s || (ke[(i = 1 === p ? 1 : 3)] && aa(Me, ke[i]))),
                      ye &&
                        !n &&
                        Math.abs(Me.getVelocity()) > (X(ye) ? ye : 2500) &&
                        (_(Me.callbackAnimation),
                        ee ? ee.progress(1) : _(k, !p, 1)))
                    : Te && ae && !Xe && ae(Me);
              }
              if (w) {
    ...
    (ScrollTrigger.register = function register(e) {
      if (
        ...
        L() &&
          ...
          ((Ne = window),
          (Re = document),
          (Ie = Re.documentElement),
          (Fe = Re.body)),
        Le &&
          ((Be = Le.utils.toArray),
          (Ve = Le.utils.clamp),
          (Ke = Le.core.suppressOverwrites || J),
        ...
        (r.borderTopStyle = "solid"),
          ...
          (c = setInterval(Oa, 200)),
          Le.delayedCall(0.5, function () {
            return (Ye = 0);
          }),
          Ea(Re, "touchcancel", J),
          Ea(Fe, "touchstart", J),
          Da(Ea, Re, "pointerdown,touchstart,mousedown", function () {
            return (je = 1);
          }),
    ...
    (ScrollTrigger.config = function config(e) {
      ...
      (t && clearInterval(c)) || ((c = t) && setInterval(Oa, t)),
        "autoRefreshEvents" in e &&
          (U(Fa) || U(Ea, e.autoRefreshEvents || "none"),
    ...
    (ScrollTrigger.scrollerProxy = function scrollerProxy(e, t) {
      var r = Be(e)[0],
        ...
        i = N(r);
      ~n && v.splice(n, i ? 6 : 2),
        i ? Ze.unshift(Ne, t, Fe, t, Ie, t) : Ze.unshift(r, t);
    }),
